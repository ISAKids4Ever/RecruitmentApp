...
export const StartButton = ({ hoverColor }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 851.3 288.1">
        <defs>
            <linearGradient
                id="a"
                x1="266.88"
        ...
        <path
            ...
            fill={hoverColor}
        />
        <path d="M412,138.5h-3.8V105.2h-8.5v-3.6h21.1v3.6H412Z" fill={hoverColor} />
        <path
        ...
        <path
            ...
            fill={hoverColor}
        />
        <path d="M484.1,138.5h-3.8V105.2h-8.5v-3.6h21.1v3.6h-8.8Z" fill={hoverColor} />
    </svg>
);
