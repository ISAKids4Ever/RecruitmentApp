    ...
    >
        <defs>
            ...
            >
                ...
                <stop offset="0.21" stop-color="#ec7347" />
                <stop offset="0.52" stop-color="#d4145a" />
            ...
            >
                ...
                <stop offset="0.42" stop-color="#e5e5e7" />
                <stop offset="0.57" stop-color="#d6d6d8" />
                <stop offset="0.7" stop-color="#c1c1c2" />
                <stop offset="0.82" stop-color="#a5a6a7" />
                <stop offset="0.94" stop-color="#838486" />
            ...
            >
                ...
                <stop offset="0.15" stop-color="#c1c2c4" />
                <stop offset="0.31" stop-color="#d6d7d9" />
                <stop offset="0.48" stop-color="#e5e6e7" />
                <stop offset="0.69" stop-color="#eeeeef" />
                <stop offset="1" stop-color="#f1f1f2" />
            </linearGradient>
        </defs>
        <title>guzik_start</title>
        ...
        <path
            ...
            fill="#9e005d"
        />
        <path d="M412,138.5h-3.8V105.2h-8.5v-3.6h21.1v3.6H412Z" fill="#9e005d" />
        <path
        ...
        <path
            ...
            fill="#9e005d"
        />
        <path d="M484.1,138.5h-3.8V105.2h-8.5v-3.6h21.1v3.6h-8.8Z" fill="#9e005d" />
    </svg>
);
